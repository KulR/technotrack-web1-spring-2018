...
def pathToAvatars(instance, filename):
    return "{}/user_{}/{}".format("avatars", instance.id, filename)


class User(AbstractUser):
    email = models.EmailField(unique=True, verbose_name=u'Email')
    avatar = models.ImageField(upload_to=pathToAvatars, null=True, blank=True, verbose_name=u'Аватар')
